...
EQUATION( "basica" )
/*
Equation for "renda básica universal"
*/
...
v[0] = VL("Q_t",1); // Trying to fix deadlock errors 
v[1] = V("h"); 
v[2] = v[0]*v[1];

if (v[2] < 0) // Garantees that firms' investment is non-negative
	{v[2] = 0;}
else {v[2] = v[2];}
...
EQUATION( "Cw_t" )
	...
	*/
	...
	v[6] = (1 - v[0])*v[1] + v[2]*(v[3] - v[1]) + (1 - v[4])*v[5] + v[6];
