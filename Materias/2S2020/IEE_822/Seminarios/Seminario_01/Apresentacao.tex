...
\begin{frame}[label={sec:org835d071}]{Estrutura do artigo}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org7e9bf9f}]{Moeda, Crédito e Crises financeiras no longo prazo: Duas eras}
...
\hline
 &  &  &  &  & \\
\end{tabular}
\end{center}\footnotetext[1]{\label{orgebab558}p-valor}
\end{center}
