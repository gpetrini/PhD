...
\begin{frame}[label={sec:orgb807eed}]{Exemplo: \href{https://www.bcb.gov.br/publicacoes/atascopom/28102020}{Ata Nº234}}
\begin{itemize}
...
\begin{frame}[label={sec:org36079ef}]{Exemplo: \href{https://www.bcb.gov.br/publicacoes/atascopom/28102020}{Ata Nº234 03/Nov/2020}}
\begin{figure}[htb]
\centering
...
\begin{frame}[label={sec:org59ab8f2}]{Descontinuidades}
...
\begin{frame}[label={sec:org6de67c3}]{Alguns resultados}
\begin{itemize}
...
\begin{frame}[label={sec:org1674885}]{Investimento público em recuperação \cite{orair_investimento_2016}}
\begin{table}[htbp]
...
\begin{frame}[label={sec:orgb928154}]{Emprego}
\begin{figure}[htb]
\centering
...
\begin{frame}[label={sec:org3fac373}]{Taxa de câmbio nominal}
\begin{figure}[htb]
\centering
...
\begin{frame}[label={sec:org4771d3e}]{Taxa de juros selic}
\begin{figure}[htb]
\centering
...
\begin{frame}[label={sec:org42e0873}]{Finalmente, inflação (ops, IPCA)}
\begin{figure}[htb]
\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:orgf2d37b8}]{Composição do IPCA \cite{bcb_2019_Atualizacoes}}
\begin{table}[htbp]
...
\end{table}
\end{frame}
\begin{frame}[label={sec:org1568556}]{Preços livres, monitorados, serviços}
\begin{figure}[htb]
\centering
...
\label{sec:org3bb9241}

\begin{frame}[label={sec:orgd26a2aa}]{Os três motores \cite{serrano_demanda_2015}}
\begin{figure}[htb]
\centering
