...
\section{Introdução}
\label{sec:org2273f79}

\begin{frame}[label={sec:orgf045947}]{Estrutura de tópicos e convenções}
...
\label{sec:org0077b80}

\begin{frame}[label={sec:orge7801ed}]{Panorama Internacional}
\begin{itemize}
...
\begin{frame}[label={sec:org8e0b58b}]{Crescimento e desequilíbrios globais}
...
\begin{frame}[label={sec:org1c7957d}]{A Herança Maldita}
\begin{itemize}
...
\label{sec:orgc2dabcb}

\begin{frame}[label={sec:orgd9c9938}]{Primeira Fase}
...
\begin{frame}[label={sec:org766c185}]{Segunda fase}
\begin{itemize}
...
\begin{frame}[label={sec:orgc20794d}]{Fatores determinantes}
\begin{itemize}
...
\begin{frame}[label={sec:org09ba64e}]{Alguns resultados}
\begin{itemize}
...
\label{sec:org1d5c1aa}

\begin{frame}[label={sec:org206cca3}]{Continuidades}
...
\begin{frame}[label={sec:org95532d0}]{Descontinuidades}
...
\begin{frame}[label={sec:orge8369cb}]{Dificuldades}
\begin{itemize}
...
\label{sec:org234cc0b}

\begin{frame}[label={sec:org753619e}]{Os três tenores}
\end{frame}

\begin{frame}[label={sec:orgab4d20d}]{Medidas macroprudenciais}
...
\begin{frame}[label={sec:org01713a0}]{Desaceleração rudimentar I}
\begin{center}
\begin{tabular}{lll}
\hline
 & 2004-2010 & 2011-2014\\
...
\begin{frame}[label={sec:orgc68190e}]{Desaceleração rudimentar II}
\begin{table}[htbp]
...
\begin{frame}[label={sec:orgd09a927}]{Desaceleração rudimentar III}
\begin{table}[htbp]
...
\begin{frame}[label={sec:org88a33b9}]{Prêambulo para a ópera do fim do mundo}
\href{./opera.jpg}{Brasil, o Golpe: A Ópera do fim do mundo - Flávio Tavares}
\end{frame}

\section{Idade das trevas}
\label{sec:org0bc2d7f}

\section{Dados}
\label{sec:orgcf705bd}

\begin{frame}[label={sec:orge8252f8}]{Índice EMBI Brasil (Fim de período)}
\end{frame}



\begin{frame}[label={sec:org9de1d7e}]{O ciclo das commodities}
\begin{figure}[htb]
\centering
...
\begin{frame}[label={sec:org98f2f0f}]{O ciclo de liquidez internacional para países emergentes}
\alert{Dado:} IIF (?)
\end{frame}
