...
Some scholars estimated residential investment based on a Tobin's Q adapted for the housing sector[fn::This adapted Tobin's Q is defined as the ratio between the market price of new houses and construction cost to build a new one.].
