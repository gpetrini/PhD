...
\usepackage[backend=biber,style=authoryear-comp, uniquename=init, giveninits, doi=false, isbn=false, maxcitenames= 2, natbib=true]{biblatex}
...
\label{sec:org76c2ee2}

\begin{frame}[label={sec:orgc2c50a8}]{Determinants of residential investment}
...
\begin{frame}[label={sec:org762f314}]{Estimation strategy}
