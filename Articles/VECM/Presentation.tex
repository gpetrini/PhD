...
\begin{frame}[label={sec:org4f4082e}]{Residential investment, business cycle and economic growth in the US economy}
\begin{itemize}
...
\begin{frame}[label={sec:org40f2fe4}]{Residential investment and the business cycle \citep{green_follow_1997,leamer_housing_2007}}
...
\begin{frame}[label={sec:org2b6186b}]{Residential investment and long-run economic growth\footnote{\tiny{HP filter, $\lambda = 1600$. We are aware of the econometric problems regarding this type of filter. For details see \textcite{NBER_HP}. This is just a visualization procedure.}} \citep{perez_Montiel_2021}}
\begin{figure}[H]
	\centering
...
\item Construction takes time (from 7 to 12 months depending on housing unity type) \hyperlink{constructionPlot}{\beamerbutton{Figure}}
\end{itemize}
...
\begin{frame}[label={sec:org9934ef5}]{Estimation strategy}
...
\begin{frame}[label={sec:orge0d8930}]{Expected results and economic meaning}
...
\section{Results}
\label{sec:org910100a}

\begin{frame}[label={sec:org16c8881}]{Estimation parameters \hyperlink{robust_frame}{\beamerbutton{Robustness check}}}
\label{back}
\begin{table}[H]
	\centering
...
\begin{frame}[label={sec:org0a39957}]{Orthogonalized Impulse Response Function}
\begin{figure}[H]
	\centering
	\includegraphics[height=.85\textheight]{./figs/Impulse_VECMOrth_grey.png}
\end{figure}
\end{frame}
\begin{frame}[label={sec:org3d65684}]{Forecast error variance decomposition}
\begin{figure}[H]
	\centering
...
\section{Conclusions}
\label{sec:org5b9eac9}
\begin{frame}[label={sec:orge75e8cb}]{Concluding remarks}
