...
\section{Residential investment, trend and business cycle in the US}
\label{sec:org657694e}
...
One way to describe housing growth rate is the houses' own interest rate proposed by \textcite{teixeira_crescimento_2015} following \citeauthor*{sraffaDrHayekMoney1932}'s \citeyear{sraffaDrHayekMoney1932} contribution.
...
\subsection{Goodhearth and Hoffman}
\label{sec:org5ed0a31}

\subsection{Arestis and Gonzalez Martinez}
\label{sec:orgead0ba2}

\section{Macroeconometric analysis}
\label{sec:orgf8b23b7}
\label{sec:VECM}
\subsection{Houses' own interest rate and residential investment growth rate in the US	Economy}
\label{sec:orgd204986}
\label{sc:own}
...
\label{sec:org541d261}
No potential conflict of interest was reported by the authors.

\section*{References}
\label{sec:org350f3d3}
\printbibliography[heading=none]


\appendix
\section{Statistical Appendix}
\label{sec:orgd8e4569}
\label{appen:A}
