...
Most of the new recommended macroprudential policies focus on household indebtedness, banking regulation and LTV rules as in \textcite{arena_2020_Macroprudential}.
While house prices bubbles and credit grant play a major role on those analysis, residential investment is only indirectly considered using housing starts as a proxy or housing unit acquisition such as \textcite{baptista_2016_Macroprudential}.
...
Besides the sensitivity on housing bubbles, we do not argue that this index is only relevant for those who build a house expecting capital gain\footnote{During a housing bubble period (\emph{e.g.} 2002-5 in the US), it is house price inflation that govern houses own rate of interest movements. So, the lowe this rate is, the greater the capital gains (in house) for speculating with houses will be.}.
The relevance of this variable is household-wide since most of them benefits from a house price increase\footnote{There may are some splillover effects that will influence other housing related-variables (such as rents). However, those consequences go beyond the definition of residential investment and, thus, are out of the scope of this paper.}.
...
The proposed index clarify the connection between asset price inflation (in this case house prices) and aggregate demand through residential investment, extending \textcite{petrini_2021_TD} and \textcite{teixeira_crescimento_2015} works to an empirical direction.
...
\label{sec:org89b49e3}
No potential conflict of interest was reported by the authors.

\section*{References}
\label{sec:orgdb05a31}
\printbibliography[heading=none]


\appendix
\section{Statistical Appendix}
\label{sec:orgd68d5af}
\label{appen:A}
