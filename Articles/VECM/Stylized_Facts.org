...
*** Begin
#+begin_src R :session *centered* :results graphics file :file ./figs/Centered_Begin_pct1.png
library(tidyverse)
library(purrr)
library(fredr)
library(lubridate)
...
*** End
#+begin_src R :session *centered* :results graphics file :file ./figs/Centered_End_pct1.png
