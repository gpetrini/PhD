...
Before moving towards the traverse, we revisit Equation ref:u_to_k in order to present houses share on total capital stock ($k$)[fn::As we will see on section ref:long, this ratio guards a special relation with marginal propensity to invest in the fully-adjusted position.].  To do so, we express firms' capital in terms of houses. 
$$
