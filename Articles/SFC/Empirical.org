...
** TODO Incluir resultados empíricos

** TODO Escrever revisão empírica sobre outros países rapidamente tal como na dissertação
...
# image/png
[[file:obipy-resources/55f4d82f99285b53283e312a47760264590346bb/53eaeb0a443ba67ff7895fcdbdcd01ea196b7194.png]]
:end:
...
\begin{figure}[htb]
    \centering
        \caption{Concentration curves for primary and secoundary houses} 
    \includegraphics[width = 0.65\textwidth]{./figs/Concentration_Curve.png}
    \label{fig:concentration}
    \caption*{\textbf{Source:} Survey of Consumer Finance, authors’ elaboration.}
\end{figure}
#+end_export
