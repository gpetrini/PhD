...
\label{sec:org6e3a2a2}
\label{sec:Model}
\subsection{General equations}
\label{sec:org88b27b5}
...
Banks create credit \emph{ex nihilo} and then collect the deposits, paying the same interest rate that they charge.
...
\label{sec:org59007d2}

\subsubsection{Workers}
\label{sec:org24c36ce}
...
\subsection{\myRed{Transition} and long-run equilibrium}
\label{sec:org24f3698}
\label{long}
...
\label{sec:orgfeaf5dc}
\label{sec:Experiments}
\label{se    c:Experiments}
In this Section, we present the results of the following numerical experiments\footnote{\myRed{It is worth mentioning that we use \citeauthor*{fazzari-2020-deman-led}'s  \citeyear{fazzari-2020-deman-led} parameter values calibrated for the U.S. economy for a similar time range (from 1980 to 2016)}.}:
...
\label{sec:org30e1b1f}
No potential conflict of interest was reported by the authors.


\section*{References}
\label{sec:orgbdcbb6c}
...
\centering
\label{tab:param}
\input{./tabs/parameters_referee.tex}
\caption*{\textbf{Source:} Authors' elaboration}
\end{table}

\section{Sensibility analysis}
\label{sec:org15518f8}
\label{append:Sensib}
\begin{table}[H]
