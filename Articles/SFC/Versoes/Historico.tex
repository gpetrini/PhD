...
\label{sec:org40aeff9}

\subsection*{Introdução}
\label{sec:org8a3fc5c}
...
\label{sec:orgb9b4960}
Não alterei nada
\subsection*{Apêndice A}
\label{sec:org6110b5c}
...
\label{sec:org02587d1}

\subsection*{Seção empírica}
\label{sec:org3554551}
...
\label{sec:orga309887}

\subsection*{Introdução}
\label{sec:org674fe8a}

Inalterada em relação à versão anterior

\subsection*{Seção Empírica}
\label{sec:org9afaaa2}

Inalterada em relação à versão anterior

\subsection*{Modelo}
\label{sec:orgbcd031d}

\subsubsection*{Equações gerais}
\label{sec:org1ca3185}
...
\subsection*{Solução analítica}
\label{sec:org9d47f63}
\subsubsection*{Short-run}
\label{sec:orgb322a1c}
...
\end{itemize}
\subsection*{Simulações}
\label{sec:org7b5ca00}
Inalterada em relação à versão anterior
\subsection*{Conclusão}
\label{sec:org50b9274}
Inalterada em relação à versão anterior
\subsection*{Apêndice A}
\label{sec:org237654a}
...
\label{sec:org3fae121}

\subsection*{Introdução}
\label{sec:orgc0e0645}

Não alterado.

\subsection*{Fatos estilizados}
\label{sec:org21715a0}

Não alterado.

\subsection*{Modelo}
\label{sec:orgb635250}

Não alterado.

\subsection*{Solução analítica}
\label{sec:org0f66870}
