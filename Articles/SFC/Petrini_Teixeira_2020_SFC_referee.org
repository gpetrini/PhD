...
#+LATEX_HEADER: \author{} % Anonimous version
...
** Referee marks :ignore:
#+LATEX_HEADER: \usepackage{etoolbox}
#+LATEX_HEADER: \usepackage{xcolor}
#+LATEX_HEADER: \newtoggle{referee}
#+LATEX_HEADER: \toggletrue{referee}
# #+LATEX_HEADER: \togglefalse{referee}
#+LATEX_HEADER: \iftoggle{referee}{\newcommand{\myRed}[1]{\textcolor{red}{#1}}}{\newcommand{\myRed}[1]{\textcolor{black}{#1}}}
** Abstract :ignore:
...
#+LATEX:  The authors wish to acknowledge the financial support from the Brazilian National Research Council (CNPq; grant 130777/2018-8). We  are  grateful  to  Lídia  Brochier,  Carolina  Baltar,  Franklin  Serrano, Stefano Di Bucchianico  and Fabrício Pitombo Leite for  discussions,  as  well  as  comments  by  the participants of Cecon/Unicamp and UFRJ Political Economy research seminars and the participants of XII AKB meeting, 20th FMM forum, 46th EEA Annual Conference and EAEPE 2020 Conference. Any remaining errors are, of course, our own.
...
#+BEGIN_SRC python :tangle ./codes/Sobol.py :session Sobol :exports none :eval never-export
...
#+BEGIN_SRC python  :tangle ./codes/Sobol.py :session Sobol :exports none :cache no :eval never-export
...
desc = {
    ...
    "omega": "wage-share",
    "alpha_k" : "Mg. prop. consume out of $YD_{k}$",
