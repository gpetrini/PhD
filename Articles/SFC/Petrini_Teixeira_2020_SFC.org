...
#+BEGIN_SRC python  :tangle ./codes/Sobol.py :async t :session Sobol :results table drawer latex :exports results :python /usr/bin/python3.8 :eval never-export
...
results["Effect of increase"] = results["Effect of increase"].map(translate)
