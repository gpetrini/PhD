...
#+LATEX_HEADER: \usepackage{svg, caption, multirow, booktabs, setspace, indentfirst, authblk}
...
* A Sraffian supermultiplier SFC model with residential investment :noexport:
#+LATEX: \label{sec:Model}
#+INCLUDE: "Model.org"



* From short- to long-run equilibria :noexport:
#+LATEX: \label{sec:runs}
#+INCLUDE: "Analytical.org"


* Numerical simulations :noexport:
