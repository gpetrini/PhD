...
#+BEGIN_SRC python :tangle ./codes/Sobol.py :async t :session Sobol :exports none :python /usr/bin/python3.8 :eval never-export
...
#+BEGIN_SRC python  :tangle ./codes/Sobol.py :async t :session Sobol :exports none :cache no :python /usr/bin/python3.8 :eval never-export
...
#+RESULTS:
#+begin_example
gamma_u     omega   gamma_F  spread_mo     phi_0     phi_1     infla         R
0.00 -2.530464 -2.087674 -2.698257  -2.698247 -3.018613 -2.691682 -2.698247 -1.092702
0.01 -2.711678 -2.095959 -2.698256  -2.698288 -1.967421 -2.692559 -2.691682 -1.100112
0.02 -2.694301 -2.104348 -2.698260  -2.698331 -2.635810 -2.693389 -2.680788 -1.107645
0.03 -2.709234 -2.112844 -2.698255  -2.698374 -2.627593 -2.694172 -2.666582 -1.115304
0.04 -2.718127 -2.121447 -2.698251  -2.698412 -2.389913 -2.694906 -2.649931 -1.123094
...       ...       ...        ...       ...       ...       ...       ...
0.96       NaN -3.816070 -2.698230  -2.699445       NaN -2.470601 -1.831873       NaN
0.97       NaN -3.785307 -2.698232  -2.699429       NaN -2.464600 -1.829003       NaN
0.98       NaN -3.749482 -2.698234  -2.699412       NaN -2.458528 -1.826174       NaN
0.99       NaN -3.709475 -2.698236  -2.699395       NaN -2.452386 -1.823388       NaN
1.00       NaN -3.666369 -2.698235  -2.699377       NaN -2.446172 -1.820641       NaN
...
results["Effect of increase"] = results["Effect of increase"].map(translate).copy(deep=True)

for i in range(len(results[long_string])):
    val = results[long_string][i]
    if val >= 1.0:
        results[long_string].iloc[i] = np.nan
