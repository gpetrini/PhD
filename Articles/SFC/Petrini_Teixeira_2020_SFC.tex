...
\affil[1]{Assistent Professor at University of Campinas (Brazil)} % Author affiliation
\author[2]{Gabriel Petrini}
\affil[2]{PhD Student at University of Campinas (Brazil)} % Author affiliation
\date{\today}
...
\label{sec:orgb0e4fcf}
\label{sec:Model}
\subsection{General equations}
\label{sec:org2a03ffa}
...
\label{sec:orgc70dfd5}

\subsubsection{Workers}
\label{sec:orgdc36b92}
...
\label{sec:org267a0e6}
No potential conflict of interest was reported by the authors.


\section*{References}
\label{sec:org7e53425}
