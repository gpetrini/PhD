...
\hypersetup{
 pdfauthor={""},
 pdftitle={Long-run effective demand and residential investment: a Sraffian supermultiplier based analysis},
 pdfkeywords={},
 pdfsubject={},
...
\subsubsection{Housing bubble and residential investment}
\label{sec:org40c5cc7}
\label{sec_own}
...
Based on \citeauthor*{Sraffa_Own_1932}'s \citeyear{Sraffa_Own_1932} commodity rate of interest, textcite:teixeira\textsubscript{crescimento}\textsubscript{2015} proposes the so-called houses own rate of interest.
...
This particular interest rate is shown in Equation ref:\textsubscript{own} in which \(own\) stands for houses own rate of interst, \(r_{mo}\) for mortgage interest rate and \(\pi\) for house price inflation.
...
\item Figure I\hfill{}\textsc{ignore}
\label{sec:org10aef15}
\begin{verbatim}
\begin{figure}[htb]
	\centering
...
\item Figure II\hfill{}\textsc{ignore}
\label{sec:org19b6234}
\begin{verbatim}
\begin{figure}[htb]
	\centering
