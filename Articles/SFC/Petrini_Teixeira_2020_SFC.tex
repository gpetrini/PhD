...
\label{sec:orgebea1f1}
\label{sec:Model}
\subsection{General equations}
\label{sec:orgcc9865d}
...
\label{sec:org1efbb51}

\subsubsection*{Workers}
\label{sec:orgb72fb87}
...
\label{sec:orgab5f1d3}
No potential conflict of interest was reported by the authors.


\section*{References}
\label{sec:orgb39f2e2}
