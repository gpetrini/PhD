...
The first variable is the mortgage interest rate (\(r_{mo}\)), which determines the financial cost of buying houses and the weight of debt-service on house investors' income.
The other is rate of change house prices (\(\pi\)).
The one who owns a house or is willing to buy one takes into consideration the change of the asset price.
This happens because of speculative reasons and trying to have capital gains, or just to prevent capital loss and reductions of net worth.
...
TRANSIÇÃO SEÇÃO SEGUINTE.

in order to analyze the relation between residential investment, real estate inflation and interest rates during the U.S. housing bubble episode.
\end{document}
