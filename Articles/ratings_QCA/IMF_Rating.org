...
#+RESULTS:
:results:
Joining, by = c("Year", "Growth", "Debt/GDP", "CA Balance/GDP", "Capital Account/GDP", "Primary Outcome/GDP", "ISO")
Joining, by = c("Year", "Growth", "Debt/GDP", "CA Balance/GDP", "Capital Account/GDP", "Primary Outcome/GDP", "ISO")
Joining, by = c("Year", "Growth", "Debt/GDP", "CA Balance/GDP", "Capital Account/GDP", "Primary Outcome/GDP", "ISO")
:end:
...
df <- df %>%
  left_join(stats, by = c("ISO", "Year"))

df <- df %>%
  left_join(bests, by = c("ISO", "Year"))
...
- Fill NAs in df, stats and bests
- Corrigir join do stats
