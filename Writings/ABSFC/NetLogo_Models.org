...
* Current version
:PROPERTIES:
  :header-args: netlogo :results code :eval never-export :session export :exports code :noweb yes
  :END:
...
#+transclude: [[file:Versions/cluster-geo/cluster-geo.org::*Implementation]]


* Noweb and tangle :ignore:
:PROPERTIES:
  :header-args: netlogo :results output drawer :eval never-export :session export :exports code :tangle ./Versions/current-version/current-version.nlogo :noweb yes
  :END:


#+transclude: [[file:Versions/cluster-geo/cluster-geo.org::*Noweb and tangle]]
