...
#+transclude: [[file:Versions/cluster-geo/cluster-geo.org::*Description and relevant information]] :level 4
...
#+transclude: [[file:Versions/cluster-geo/cluster-geo.org::*Implementation]] :level 4
...
#+transclude: [[file:Versions/cluster-geo/cluster-geo.org::*Noweb and tangle]] :level 4 :only-contents
