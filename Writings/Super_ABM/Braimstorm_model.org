...
* Version <2021-07-09 sex>: Fully induced investment - Bottom up, top down or both of them?
...
** Empirical validation and contrafactuals
...
In the first one, firms' expectation will change accordingly to its forescasting errors in line with textcite:reissl_2021_Heterogeneousa,dosi_2020_RATIONAL.
...
- Strong trend
- Weak trend
- Anchoring and adjustment (moving average)
...
- neo-Kaleckian :: $g^{K} = \overline{\gamma_{0}} + \gamma_{1} (u - u_{N})$
- neo-Kaleckian supermultiplier :: $g^{K} = \gamma_{0} + \gamma_{1}(u - u_{N})$ while $\Delta \gamma_{0} = \gamma_{0}\cdot\gamma_{u} (u - u_{N})$
- Sraffian supermultiplier :: $g^{K} = \frac{h\cdot u}{v}$ while $\Delta h = h_{t-1}\cdot \gamma_{u} (u - u_{N})$ and $I = h\cdot Y$
...
- Expectational change mechanism: $\Delta g^{e}: g^{e} \to g^{I} $
- Investment function change mechanism: $\Delta g^{I}: u \to u_{N}$
