...
<ipython-input-9-2d027b2231bd> in <module>
     10 for date in datelist:
     11     url = f"http://sdro.ons.org.br/SDRO/DIARIO/{date}/HTML/07_DadosDiariosAcumulados_Regiao.html"
---> 12     bra = bra.append(pd.read_html(
     13         url,
     14         parse_dates=True,

~/.local/lib/python3.8/site-packages/pandas/io/html.py in read_html(io, match, flavor, header, index_col, skiprows, attrs, parse_dates, thousands, encoding, decimal, converters, na_values, keep_default_na, displayed_only)
   1083         )
...
~/.local/lib/python3.8/site-packages/pandas/io/html.py in _parse(flavor, io, match, attrs, encoding, displayed_only, **kwargs)
    893 
    894         try:
...
~/.local/lib/python3.8/site-packages/pandas/io/html.py in parse_tables(self)
...
~/.local/lib/python3.8/site-packages/pandas/io/html.py in _build_doc(self)
    731                     pass
    732             else:
--> 733                 raise e
    734         else:
...
# Out [10]: 
# output
<ipython-input-7-06392b792fc4>:74: UserWarning: This figure includes Axes that are not compatible with tight_layout, so results might be incorrect.
  plt.tight_layout()
...
# image/png
[[file:obipy-resources/62e383af79e91b63c7fc98dd7fb55b3c3ececcb9/4091538b732030417f0b9eb36ccac778383dbb05.png]]
:end:
...
# text/plain
: (<Figure size 2400x1500 with 4 Axes>,
:  array([<matplotlib.axes._subplots.AxesSubplot object at 0x7f8f5bef9610>,
:         <matplotlib.axes._subplots.AxesSubplot object at 0x7f8f5b6d48b0>],
:        dtype=object))
...
<ipython-input-33-f5ad43e4d316> in <module>
      9     lw = 2.5
     10 )
...
---------------------------------------------------------------------------
NameError                                 Traceback (most recent call last)
<ipython-input-35-bd6352613dfc> in <module>
      9     lw = 2.5
     10 )
---> 11 ax.axvline(x = corona, color='black', ls='--', lw=1, label='Início do isolamento em SP\n(24 de março)')
     12 ax.legend(loc='center left', bbox_to_anchor=(1, 0.5))
